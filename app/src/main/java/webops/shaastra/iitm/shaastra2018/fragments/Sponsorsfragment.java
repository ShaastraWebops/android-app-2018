...
public class Sponsorsfragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sponsorsfragment, container, false);
        WebView webView = (WebView)view.findViewById(R.id.web_sponsors);
        WebSettings webSettings = webView.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webView.setWebViewClient(new MyCustomWebViewClient(progressDialog));
        webView.loadUrl("http://shaastra.org/#/sponsors");
        return view;
    }
    ...
    private class MyCustomWebViewClient extends WebViewClient {
        ...
        public MyCustomWebViewClient(ProgressDialog progressBar) {
            ...
            this.progressBar.setMessage("Loading Sponsors....");
